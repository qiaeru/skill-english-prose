...
**After:**
> "You can have speed, quality, or low cost, but only two at a time."

**Changes:** One complete sentence, no performative fragments, no em dash.
...
**Before:**
> "We rewrote the build pipeline in Rust. The result? Builds that used to take twenty minutes now finish in four. The catch? Nobody on the team knew Rust."
...
**Before:**
> "Ship daily. Talk to users. Cut scope. Repeat. That's the job. Everything else is noise."

**After:**
> "The job is to ship something every day, talk to the users it lands on, and cut whatever scope keeps you from doing those two things again tomorrow."

**Changes:** The slogans became one flowing sentence; same advice, human rhythm, no false dichotomy at the end.

## Example 19: Cliché Closer
